...
class HiggsAudioConfig(PretrainedConfig):
    ...
    Args:
        ...
        num_audio_channels (`int`, *optional*, defaults to 2):
            The number of audio channels (e.g., 2 for stereo audio).
        use_audio_channel_embedding (`bool`, *optional*, defaults to False):
            Whether to use channel embeddings to distinguish audio tokens from different channels.
            When enabled, each audio token will have an additional channel embedding added to it.
    """
    ...
    def __init__(
        ...
        use_audio_channel_embedding=False,
        **kwargs,
    ):
        ...
        self.use_audio_channel_embedding = use_audio_channel_embedding
